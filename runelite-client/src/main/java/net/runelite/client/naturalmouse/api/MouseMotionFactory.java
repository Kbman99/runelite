...
public class MouseMotionFactory {
   ...
   */
  public MouseMotion build(Component source, int xDest, int yDest) {
    return new MouseMotion(source, nature, random, xDest, yDest);
  }
   ...
   */
  public void move(Component source, int xDest, int yDest) throws InterruptedException {
    build(source, xDest, yDest).move();
  }
